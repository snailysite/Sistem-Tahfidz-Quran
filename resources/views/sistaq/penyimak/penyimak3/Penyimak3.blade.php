...
<div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Data Ustadz Penyimak Tahfidz 3</h1>
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Data Ustadz Penyimak Tahfidz 3</a></li>
...
<section class="content">
    <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data ustadz penyimak program tahfidz 3 ponpes sunan pandanaran</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table id="example1" class="table table-head-fixed table-hover table-bordered">
            ...
            <tbody>
                ...
                <td class="text-center">
                        ...
                        <a href="{{url('/editpenyimak3/'.$penyimak->id)}}">
                        ...
                        <a href="{{url('/deletepenyimak3/'.$penyimak->id)}}">
