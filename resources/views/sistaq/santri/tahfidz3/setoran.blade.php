...
<div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Data Hafalan Santri Tahfidz 3</h1>

      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Data Hafalan Santri Tahfidz 3</a></li>
...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data setoran hafalan santri program tahfidz 3 ponpes sunan pandanaran</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table id="example1" class="table table-head-fixed table-hover table-bordered">
            ...
            <tr>
                ...
                <td>
                    <select class="form-control" style="width: 100%;" name="juz" disabled>
                ...
                <td>
                    <select class="form-control" style="width: 100%;" name="surah" disabled>
