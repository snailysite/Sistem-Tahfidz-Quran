    ...
    {{--  import excel  --}}
                ...
                <div class="modal fade" id="contohModal" role="dialog" arialabelledby="modalLabel" area-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form action="/SantriImportexcel" method="post" enctype="multipart/form-data">
                            @csrf
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Data Santri Tahfidz 1</a></li>
...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data santri program tahfidz 1 ponpes sunan pandanaran</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table id="example1" class="table table-head-fixed table-hover table-bordered">
            ...
            <tbody>
                ...
                <td class="text-center">
                    <a href="{{url('/editsantri/'.$santri->id) }}">
                    ...
                    <a href="{{url('/deletesantri/'.$santri->id) }}">
                    ...
                    <a href="{{url('/printkode/'.$santri->id) }}">
