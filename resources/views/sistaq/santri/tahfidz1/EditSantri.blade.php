...
<div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Edit Data Santri Tahfidz 1</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Edit Data Santri Tahfidz 1</a></li>
        ...
        <div class="container-fluid">
          ...
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Edit Data Santri Tahfidz 1</h3>
            </div>
            <form action="{{url('/proses-edit')}}" method="post">
                {{csrf_field()}}
                <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
