...
<div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Presensi Santri Tahfidz 1</h1>

      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Presensi Santri Tahfidz 1</a></li>
...
<section class="content">
    <div class="card">
        <div class="card-header">
          <h3 class="card-title">Presensi santri program tahfidz 1 ponpes sunan pandanaran</h3>
